...
/* Definitions for FFTHalfSem */
osSemaphoreId_t FFTHalfSemHandle;
const osSemaphoreAttr_t FFTHalfSem_attributes = {
  .name = "FFTHalfSem"
};
/* Definitions for FFTFullSem */
osSemaphoreId_t FFTFullSemHandle;
const osSemaphoreAttr_t FFTFullSem_attributes = {
  .name = "FFTFullSem"
};
/* USER CODE BEGIN PV */
uint16_t adc_buffer[N];
uint16_t dac_buffer[N];
...
//	size_t length = sizeof(dac_buffer) / sizeof(dac_buffer[0]);
